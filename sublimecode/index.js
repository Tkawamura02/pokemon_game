...
const player = new Sprite({
	position: {
		x: canvas.width / 2 - 192 / 4 / 2, //location of image x-axis
		y: canvas.height / 2 - 10 / 2, //location of image y-axis
	},
...
function animate() {
	const animationId = window.requestAnimationFrame(animate) //recursive loop to load background image
	background.draw();
